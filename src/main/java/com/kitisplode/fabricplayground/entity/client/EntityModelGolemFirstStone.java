...
public class EntityModelGolemFirstStone extends GeoModel<EntityGolemFirstStone>
{
	...
	{
		return new Identifier(FabricPlaygroundMod.MOD_ID, "geo/first_stone_2.geo.json");
	}
	...
	{
		return new Identifier(FabricPlaygroundMod.MOD_ID, "animations/first_stone_2.animation.json");
	}
